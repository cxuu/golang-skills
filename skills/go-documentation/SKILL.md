...
> For detailed formatting rules (headings, links, doc links, lists, code blocks), signal boosting, and preview commands, see [references/FORMATTING.md](references/FORMATTING.md).
...
- [go-style-core](../go-style-core/SKILL.md): Core Go style principles and formatting guidelines
- [go-naming](../go-naming/SKILL.md): Naming conventions for Go identifiers
- [go-linting](../go-linting/SKILL.md): Linting tools for documentation and code quality
